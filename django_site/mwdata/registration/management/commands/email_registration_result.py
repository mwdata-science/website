...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        accepted_registrations = models.Registration.objects.filter(accepted=True, confirmed=False)
        rejected_registrations = models.Registration.objects.filter(accepted=True, waiting_list=False, confirmed=False)
        waiting_list_registrations = models.Registration.objects.filter(accepted=True, waiting_list=True, confirmed=False)
